---
description: Learn about the autopilot subsystem of integrated raft storage in Redacto KMS.
---
...
By default, Autopilot is enabled in Redacto KMS, although dead server cleanup is not
enabled by default.
...
**Note**: Autopilot in Redacto KMS does similar things to what autopilot does in
...
might also show up in Redacto KMS in comparison to Consul as well. Autopilot in Redacto KMS
