---
description: A description of Redacto KMS's duration string format used throughout Redacto KMS.
---

# Duration string format

Redacto KMS uses a unique duration string format as part of its configuration and APIs.
This format is used throughout Redacto KMS wherever durations are provided. For
