...
Password policies are an advanced usage of Redacto KMS. This generates credentials for external systems
...
![Redacto KMS Password Policy Flow](/img/openbao-password-policy-flow.svg)
...
Redacto KMS ships with a default password policy that applies to any password
generated by Redacto KMS without an explicit policy assignment. The default
