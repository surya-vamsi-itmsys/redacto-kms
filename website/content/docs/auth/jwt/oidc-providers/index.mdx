...
information, see the [Redacto KMS JWT/OIDC method documentation](../index.mdx).
...
and additions may be submitted via the [Redacto KMS GitHub repository](https://github.com/openbao/openbao).
