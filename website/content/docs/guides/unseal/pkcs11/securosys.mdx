...
The upstream Redacto KMS container images don't include the Securosys PKCS#11
library. To make the library available to the Redacto KMS pod on Kubernetes, use
one of the following methods.

#### Option 1: Create a custom Redacto KMS container image
...
Redacto KMS does not automatically generate the key in the HSM. To create the key,
...
Configure the PKCS#11 seal in the Redacto KMS configuration:
...
## Initialize Redacto KMS

Finally, initialize Redacto KMS:
