...
description: This is the API documentation for the Redacto KMS KV secrets engine, version 1.
---

# KV secrets engine - version 1 (API)

This is the API documentation for the Redacto KMS KV secrets engine. For general
information about the usage and operation of the version 1 KV secrets engine, please
see the [Redacto KMS KV documentation](../../../secrets/kv/kv-v1.mdx). For information
...
`/secret` path in Redacto KMS. Since it is possible to enable secrets engines at any
...
See the [Redacto KMS KV secrets engine documentation](../../../secrets/kv/kv-v1.mdx#ttls)
for more details.
...
- `:key` `(string: "")` – Specifies a key in the payload, paired with an associated value, to
  ...
  some special behavior. See the [Redacto KMS KV secrets engine
