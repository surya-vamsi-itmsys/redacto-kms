...
description: This is the API documentation for the Redacto KMS KV secrets engine, version 2.
---

# KV secrets engine - version 2 (API)

This is the API documentation for the Redacto KMS KV secrets engine while running in
versioned mode. For general information about the usage and operation of the version 2
KV secrets engine, please see the [Redacto KMS KV documentation](../../../secrets/kv/kv-v2.mdx).
...
- `max_versions` `(int: 0)` – The number of versions to keep per key. This value
  ...
  will be permanently deleted. When 0 is used or the value is unset, Redacto KMS
