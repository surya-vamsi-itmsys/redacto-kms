...
description: >-
  The Valkey plugin for Redacto KMS's database secrets engine generates [ACL credentials](https://valkey.io/docs/manual/security/acl/)
...
- `username` `(string: <required>)` – Specifies the username for Redacto KMS to use.
