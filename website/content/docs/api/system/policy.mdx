---
description: The `/sys/policy` endpoint is used to manage ACL policies in Redacto KMS.
---

# `/sys/policy`

The `/sys/policy` endpoint is used to manage ACL policies in Redacto KMS.
