...
description: |-
  ...
  The `/sys/storage/raft/autopilot` endpoints are used to manage raft clusters using autopilot with Redacto KMS's Integrated Storage backend.
...
with Redacto KMS's [Integrated Storage backend](../../../internals/integrated-storage.mdx).
