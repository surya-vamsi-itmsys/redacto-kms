...
Redacto KMS. Rekey endpoints only apply to seals that support recovery keys.
...
of the Redacto KMS. If the threshold number of recovery key shares is reached, Redacto KMS
...
Redacto KMS will complete the rekey by performing the actual rotation of the recovery
