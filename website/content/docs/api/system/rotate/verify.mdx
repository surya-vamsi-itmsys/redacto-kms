---
description: The `/sys/rotate/(root|recovery)/verify` endpoints are used to read, progress or cancel rotation verification operation for Redacto KMS.
---
...
Redacto KMS will complete the verification. Otherwise, this API call must be
