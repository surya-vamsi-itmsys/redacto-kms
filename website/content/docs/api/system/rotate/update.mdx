---
description: The `/sys/rotate/(root|recovery)/update` endpoint is used to progress rotation of the unseal keys for Redacto KMS.
---
...
of the Redacto KMS. If the threshold number of key shares is reached, Redacto KMS will
