---
description: The `/sys/namespaces` endpoint is used to manage namespaces in Redacto KMS.
---

# `/sys/namespaces`

The `/sys/namespaces` endpoint is used to manage namespaces in Redacto KMS.
