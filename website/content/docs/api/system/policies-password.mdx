---
description: >-
  The `/sys/policies/password` endpoints are used to manage password generation policies in Redacto KMS.
---
...
Prior to Redacto KMS saving the password policy, it will attempt to generate a number of passwords
...
$ redacto-kms write sys/policies/password/my-policy policy=@my-policy.hcl
```
