---
description: The `/sys/mounts` endpoint is used to manage secrets engines in Redacto KMS.
---

# `/sys/mounts`

The `/sys/mounts` endpoint is used to manage secrets engines in Redacto KMS.
...
secrets backing service, one can force a secrets engine disable in Redacto KMS by
