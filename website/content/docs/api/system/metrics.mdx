---
description: The `/sys/metrics` endpoint is used to get telemetry metrics for Redacto KMS.
---

# `/sys/metrics`

The `/sys/metrics` endpoint is used to get telemetry metrics for Redacto KMS.

## Read telemetry metrics

This endpoint returns the telemetry metrics for Redacto KMS. It can be used by metrics
