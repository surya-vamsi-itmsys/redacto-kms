...
description: |-
  This is the API documentation for the Redacto KMS username and password
  auth method.
---

# Userpass auth method (HTTP API)

This is the API documentation for the Redacto KMS Username & Password auth method. For
general information about the usage and operation of the Username and Password method, please
see the [Redacto KMS Userpass method documentation](../../auth/userpass.mdx).
