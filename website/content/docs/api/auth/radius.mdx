...
description: This is the API documentation for the Redacto KMS RADIUS auth method.
---

# RADIUS auth method (API)

This is the API documentation for the Redacto KMS RADIUS auth method. For
general information about the usage and operation of the RADIUS method, please
see the [Redacto KMS RADIUS method documentation](../../auth/radius.mdx).
