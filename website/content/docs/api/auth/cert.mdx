...
description: |-
  This is the API documentation for the Redacto KMS TLS Certificate authentication
  method.
---
...
Certificate method, please see the [Redacto KMS TLS Certificate method documentation](../../auth/cert.mdx).

This documentation assumes the TLS Certificate method is mounted at the
`/auth/cert` path in Redacto KMS. Since it is possible to enable auth methods at any
