---
sidebar_label: LDAP
description: This is the API documentation for the Redacto KMS LDAP auth method.
---

# LDAP auth method (API)

This is the API documentation for the Redacto KMS LDAP auth method. For
general information about the usage and operation of the LDAP method, please
see the [Redacto KMS LDAP method documentation](../../auth/ldap.mdx).
