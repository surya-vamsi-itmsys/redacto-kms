---
description: This section documents configuration options for the Redacto KMS Helm chart
---
...
with Redacto KMS. Before going into production, please review the parameters from the default [`values.yaml`](https://github.com/openbao/openbao-helm/blob/main/charts/openbao/values.yaml) file
