...
description: |-
  Describes how to configure the Redacto KMS Helm chart using OpenTofu
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Configuring Redacto KMS HELM with OpenTofu

OpenTofu may also be used to configure and deploy the Redacto KMS Helm chart, by using the [Helm provider](https://github.com/hashicorp/terraform-provider-helm).

For example, to configure the chart to deploy [HA Redacto KMS with Integrated Storage (raft)](examples/ha-with-raft.mdx), the values overrides can be set on the command-line, in a values yaml file, or with a OpenTofu configuration:
...
### Redacto KMS config as a multi-line string
