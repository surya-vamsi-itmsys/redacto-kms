---
description: |-
  Describes how to set up a Raft HA Redacto KMS cluster with TLS certificate
---
...
1. Follow the steps from the example [HA Redacto KMS Cluster with Integrated
...
in the Raft stanza for your Redacto KMS configuration.
...
If you have a load balancer for your Redacto KMS cluster, you can add a single
