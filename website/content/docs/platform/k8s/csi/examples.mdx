...
description: This section documents examples of using the Redacto KMS CSI Provider.
---

# Redacto KMS CSI provider examples

The following examples demonstrate how the Redacto KMS CSI Provider can be used.

:::warning

A common mistake is to not install the CSI Secret Store Driver before using the Redacto KMS CSI Provider.

:::

## File based dynamic database credentials

The following Secret Provider Class retrieves dynamic database credentials from Redacto KMS and
