...
description: |-
  Learn about how telemetry metrics are structured in Redacto KMS
---
...
Redacto KMS provides three types of telemetry metrics:
...
- **Summary metrics** provide observational values. Redacto KMS commonly uses
