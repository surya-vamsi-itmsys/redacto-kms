...
Redacto KMS server configuration file. These audit devices are enabled and disabled
...
The `audit` stanza specifies various configurations for Redacto KMS to create
