...
description: |-
  The OVHcloud KMS seal configures Redacto KMS to use OVHcloud KMS as the seal wrapping mechanism.
---
...
- The presence of a `seal "ovhcloud"` block in Redacto KMS's configuration file.
- The presence of the environment variable `REDACTO_KMS_SEAL_TYPE` set to `ovhcloud`.
...
Redacto KMS authenticates to OVHcloud KMS using one of the following methods:
