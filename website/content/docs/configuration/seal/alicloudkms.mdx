...
description: >-
  The AliCloud KMS seal configures Redacto KMS to use AliCloud KMS as the seal
  wrapping mechanism.
---
...
The AliCloud KMS seal configures Redacto KMS to use AliCloud KMS as the seal wrapping mechanism.
The AliCloud KMS seal is activated by one of the following:

- The presence of a `seal "alicloudkms"` block in Redacto KMS's configuration file.
- The presence of the environment variable `REDACTO_KMS_SEAL_TYPE` set to `alicloudkms`. If
...
This example shows configuring AliCloud KMS seal through the Redacto KMS configuration file
