...
description: >-
  The GCP Cloud KMS seal configures Redacto KMS to use GCP Cloud KMS as the seal
  wrapping mechanism.
---
...
- The presence of a `seal "gcpckms"` block in Redacto KMS's configuration file.
- The presence of the environment variable `REDACTO_KMS_SEAL_TYPE` set to `gcpckms`.
...
This example shows configuring GCP Cloud KMS seal through the Redacto KMS
