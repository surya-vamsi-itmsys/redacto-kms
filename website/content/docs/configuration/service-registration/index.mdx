...
description: |-
  The optional `service_registration` stanza configures Redacto KMS's mechanism for
...
Service registration configuration is done through the Redacto KMS configuration file
