...
description: Kubernetes Method for Redacto KMS Auto-Auth
---

# Redacto KMS Auto-Auth kubernetes method
...
- `role` `(string: required)` - The role to authenticate against on Redacto KMS
