---
sidebar_label: Cert
description: Cert Method for Redacto KMS Auto-Auth
---

# Redacto KMS Auto-Auth cert method
...
- `ca_cert` `(string: optional)` - Path on the local disk to a single
  PEM-encoded CA certificate to verify the Redacto KMS server's SSL certificate.
