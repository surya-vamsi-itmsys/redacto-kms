...
**Redacto KMS as Consul CA provider:** If you are using Redacto KMS as a Connect CA,
...
a verification and signing process to complete. Redacto KMS's built-in authentication
...
The PKI Secrets Engine documentation is split into the following pieces:
 ...
 - [Troubleshooting ACME](troubleshooting-acme.mdx) - A list of
   advice for troubleshooting failures with ACME issuance and Redacto KMS PKI.
