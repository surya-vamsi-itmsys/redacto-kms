...
sidebar_label: list
description: |-
  The "secrets list" command lists the enabled secrets engines on the Redacto KMS
...
The `secrets list` command lists the enabled secrets engines on the Redacto KMS server.
