...
description: |-
  ...
  Redacto KMS's plugins and the plugin catalog.
---

# plugin

The `plugin` command groups subcommands for interacting with Redacto KMS's plugins and
the plugin catalog
...
```shell-session
$ redacto-kms plugin info secret my-custom-plugin
Key                   Value
---                   -----
args                  []
builtin               false
