...
description: |-
  ...
  using a parent certificate in Redacto KMS.
---
...
Usage: `redacto-kms pki issue [flags] <parent> <child_mount> [options]`
...
- `-type` `(string: "internal")` - This determines the type of key use for the
   ...
   a key already present in the Redacto KMS-backend to be used (and expect option
