---
description: |-
  The "status" command prints the current state of Redacto KMS including whether it is
  sealed and if HA mode is enabled. This command prints regardless of whether
  the Redacto KMS is sealed.
---
...
- "Unseal Progress" and "Unseal Nonce" are displayed when Redacto KMS is sealed.
