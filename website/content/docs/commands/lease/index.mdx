...
The `lease` command groups subcommands for interacting with leases attached to
secrets. For leases attached to tokens, use the [`redacto-kms token`](../token/index.mdx) subcommand.
...
```shell-session
$ redacto-kms lease lookup database/creds/readonly/27e1b9a1-27b8-83d9-9fe0-d99d786bdc83
Key             Value
---             -----
...
```shell-session
$ redacto-kms lease renew database/creds/readonly/27e1b9a1-27b8-83d9-9fe0-d99d786bdc83
Key                Value
---                -----
...
```shell-session
$ redacto-kms lease revoke database/creds/readonly/27e1b9a1-27b8-83d9-9fe0-d99d786bdc83
