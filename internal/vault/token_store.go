...
it.
`
	tokenBackendHelp = `The token credential backend is always enabled and builtin to Redacto KMS.
Client tokens are used to identify a client and to allow Redacto KMS to associate policies and ACLs
