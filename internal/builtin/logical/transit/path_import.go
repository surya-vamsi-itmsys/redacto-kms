...
with the wrapping key and then concatenated with the import key, wrapped by the AES key.`,
			...
			"allow_rotation": {
				...
				Description: "True if the imported key may be rotated within Redacto KMS; false otherwise.",
			},
			"derived": {
				Type: framework.TypeBool,
...
const (
	...
	pathImportWriteDesc = "This path is used to import an externally-generated " +
		"key into Redacto KMS. The import operation creates a new key and cannot be used to " +
