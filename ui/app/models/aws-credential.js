...
export default Model.extend({
  helpText:
    'For Redacto KMS roles of credential type iam_user, there are no inputs, just submit the form. Choose a type to change the input options.',
  role: attr('object', {
    readOnly: true,
  }),
  ...
  roleArn: attr('string', {
    label: 'Role ARN',
    helpText:
      'The ARN of the role to assume if credential_type on the Redacto KMS role is assumed_role. Optional if the role has a single role ARN; required otherwise.',
  }),
