...
export default Model.extend({
  ...
  password_policy: attr('string', {
    ...
    defaultSubText:
      'Unless a custom policy is specified, Redacto KMS will use a default: 20 characters with at least 1 uppercase, 1 lowercase, 1 number, and 1 dash character.',
  ...
  username_template: attr('string', {
    ...
    defaultSubText:
      'Template describing how dynamic usernames are generated. Redacto KMS will use the default for this plugin.',
  ...
  root_rotation_statements: attr({
    subText: `The database statements to be executed to rotate the root user's credentials. If nothing is entered, Redacto KMS will use a reasonable default.`,
