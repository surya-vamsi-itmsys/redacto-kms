...
export default Model.extend({
  ...
  default_ttl: attr({
    ...
    helperTextDisabled: 'Redacto KMS will use a TTL of 1 hour.',
  ...
  max_ttl: attr({
    ...
    helperTextDisabled: 'Redacto KMS will use a TTL of 24 hours.',
    defaultShown: 'Engine default',
  }),
  username: attr('string', {
    subText: 'The database username that this Redacto KMS role corresponds to.',
  }),
  rotation_period: attr({
    editType: 'ttl',
    defaultValue: '24h',
    helperTextDisabled:
      'Specifies the amount of time Redacto KMS should wait before rotating the password. The minimum is 5 seconds. Default is 24 hours.',
    helperTextEnabled: 'Redacto KMS will rotate password after',
  }),
