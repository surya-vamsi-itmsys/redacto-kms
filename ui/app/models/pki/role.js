...
export default class PkiRoleModel extends Model {
  ...
  @attr({
    ...
    helperTextDisabled: 'Redacto KMS will use the default value, 30s',
    helperTextEnabled:
  ...
  @attr('boolean', {
    ...
    subText:
      'Specifies if certificates issued/signed against this role will have Redacto KMS leases attached to them.',
    editType: 'boolean',
  ...
  get fieldGroupsInfo() {
    return {
      ...
      'Subject Alternative Name (SAN) Options': {
        header: {
          text: `Subject Alternative Names (SANs) are identities (domains, IP addresses, and URIs) Redacto KMS attaches to the requested certificates.`,
        },
      },
      'Additional subject fields': {
        header: {
          text: `Additional identity metadata Redacto KMS can attach to the requested certificates.`,
        },
      },
    };
  }
