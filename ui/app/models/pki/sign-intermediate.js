...
export default class PkiSignIntermediateModel extends PkiCertificateBaseModel {
  ...
  @attr({
    ...
    subText:
      'Value for the subject key identifier, specified as a string in hex format. If this is empty, Redacto KMS will automatically calculate the SKID. ',
  })
  skid;
  ...
  @attr('string', {
    subText:
      "Specifies the requested Subject's named Serial Number value. This has no impact on the Certificate's serial number randomly generated by Redacto KMS.",
  })
  subjectSerialNumber;
}
