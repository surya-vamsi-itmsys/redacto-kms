...
module('Integration | Component | kubernetes | Page::Configure', function (hooks) {
  ...
  test('it should check for inferred config variables', async function (assert) {
    ...
    const error =
      'Redacto KMS could not infer a configuration from your environment variables. Check your configuration file to edit or delete them, or configure manually.';
  ...
  test('it should show confirmation modal when saving edits', async function (assert) {
    ...
    assert
      .dom('.modal-card-body')
      .hasText(
        'Making changes to your configuration may affect how Redacto KMS will reach the Kubernetes API and authenticate with it. Are you sure?',
