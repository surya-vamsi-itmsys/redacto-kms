    ...
    this.server.post('/identity/mfa/method/totp/generate', (scheme, req) => {
      ...
      return {
        data: {
          ...
          url: 'otpauth://totp/Vault:26606dbe-d8ea-82ca-41b0-1250a4484079?algorithm=SHA1&digits=6&issuer=Redacto KMS&period=30&secret=FID3WRPRRADQDN3CGPVVOLKCXTZZPSML',
          lease_duration: 0,
        },
      };
    });
